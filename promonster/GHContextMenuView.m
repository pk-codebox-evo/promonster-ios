...
//        [self addGestureRecognizer:_longPressRecognizer];
        ...
        self.itemBGHighlightedColor = [UIColor colorWithRed:255/255.0f green:0/255.0f blue:0/255.0f alpha:1.0f].CGColor;
...
//        UIView *VI = [[UIView alloc] initWithFrame:CGRectMake(0, 50, 320, 500)];
//        self.frame = VI.frame;
    ...
    if (self.isShowing && self.isPaning) {
        ...
        if (closeToIndex >= 0 && closeToIndex < self.menuItems.count) {
            ...
            if (fabs(distanceFromItem) < toleranceDistance ) {
                ...
                layer.backgroundColor = [UIColor colorWithRed:92/255.0f green:202/255.0f blue:222/255.0f alpha:1.0f].CGColor;
