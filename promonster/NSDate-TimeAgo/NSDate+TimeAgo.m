...
- (NSString *)dateTimeAgo
{
    ...
    else if (components.weekOfMonth >= 1) // mudei de week para weekOfMonth Conrado
    {
        if (components.weekOfMonth == 1) // mudei de week para weekOfMonth Conrado
        {
            return NSDateTimeAgoLocalizedStrings(@"1 week ago");
        }
        return [self stringFromFormat:@"%%d %@weeks ago"
                            withValue:components.weekOfMonth]; // mudei de week para weekOfMonth Conrado
    }
